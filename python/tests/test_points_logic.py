...
def test_no_reduction_returns_zero(db, monkeypatch):
    ...
    monkeypatch.setattr(services, 'get_total_grams_for_weeks', lambda _db, uid, weeks_ago=4: 400.0)
...
def test_baseline_limits_the_rate(db, monkeypatch):
    ...
    monkeypatch.setattr(services, 'get_total_grams_for_weeks', lambda _db, uid, weeks_ago=4: 800.0)
...
def test_baseline_and_last_week_zero_and_this_week_zero(db, monkeypatch):
    ...
    monkeypatch.setattr(services, 'get_total_grams_for_weeks', lambda _db, uid, weeks_ago=4: 0.0)
...
def test_minimum_reduction_threshold(db, monkeypatch):
    ...
    monkeypatch.setattr(services, 'get_total_grams_for_weeks', lambda _db, uid, weeks_ago=4: 500.0)
