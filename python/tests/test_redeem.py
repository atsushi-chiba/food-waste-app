...
def test_redeem_success_and_failure():
    with app.test_client() as client:
        ...
        try:
            ...
            u = User(username='redeemtest', password='x', email='redeemtest@example.com', total_points=600)
            db.add(u)
            db.commit()
            db.refresh(u)
            ...
            resp = client.post('/api/redeem', json={'item_name': 'エコバッグ', 'cost': 500})
            ...
            resp2 = client.post('/api/redeem', json={'item_name': 'リサイクルボックス', 'cost': 200})
